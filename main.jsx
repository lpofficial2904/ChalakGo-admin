...
function JaipurTourPlanLink() {
  ...
  useEffect(() => {
    const check = () =>
      setVisible(
        [...document.querySelectorAll('input')].some((input) => input.value === 'Jaipur Tour')
      )
    check()
  ...
  return (
    <a href="/jaipur-tour" aria-label="Manage Jaipur Tour packages" className="jaipur-plan-link">
